...
The primary objective of this project was to explore the tools necessary to work in the intersection of infectious disease epidemiology modeling and data science. Specifically, we wanted to examime the seasonality of influenza in different regions in the world using country-level influenza data.

###Data

The data were obtained from The WHO FLunet. We queried data from all 18 influenza transmission zones from year 2008 thru 2014.  In order to to calculate rates, we needed population data for each zone, which we obtained from the World Bank.  
...
The Key Findings for the report can be found below. The full report can be found in the [Report](https://github.com/mattperrotta/final_project/blob/master/report_and_data.md) tab.
